App.info({
    id: 'com.example.meteor.ionic2.boilerplate',
    name: 'Ionic2-Meteor-Boilerplate',
    description: 'A boilerplate setup for an Ionic2 styled Angular2-Meteor application',
